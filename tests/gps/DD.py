    ...
    def init_images(self):
        self.images = {"system": tk.PhotoImage(file = "images/icon/settings_36dp.png"),
		       ...
		       "power75": tk.PhotoImage(file = "images/icon/battery/power75.png"),
                       ...
                       "gps": tk.PhotoImage(file = "images/icon/gps.png"),
                       "gps_fix": tk.PhotoImage(file = "images/icon/gps_fix.png")}
...
class BarPage(tk.Frame):
    def __init__(self, master):
        ...
        # GPS
        self.gpsLabel = tk.Label(self, image=master.images['gps'], bg=button_bg)
        self.gpsLabel.pack(side="right", fill="x", padx=10)
        ...
        self.latitude = None
        self.longitude = None
        self.tracker = threading.Thread(target = lambda: self.gpsTracker())
        self.tracker.daemon = True
        self.tracker.start()

    def gpsTracker(self):
        uart = serial.Serial("/dev/ttyS4", baudrate=9600, timeout=10)
        ...
        while True:
            ...
            if current - last_print >= 1.0:
                ...
                if not gps.has_fix:
                    ...
                    print("Waiting for fix... NEMA %s" % format(gps.nmea_sentence))
                    continue
